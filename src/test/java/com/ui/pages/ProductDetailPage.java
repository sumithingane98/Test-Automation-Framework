...
public class ProductDetailPage extends BrowserUtility {
	...
	// Below Visible Text from dropdown is not working due to UI issue  -> use SelectByValue
//	public ProductDetailPage changeSize(Size size) {
//		selectFromDropDownVisibleText(SIZE_DROP_DOWN_LOCATOR, size.toString());
//		return new ProductDetailPage(getDriver());
//	}
	
	public ProductDetailPage changeSize() {
		selectFromDropDown(SIZE_DROP_DOWN_LOCATOR, "3");
		return new ProductDetailPage(getDriver());
	}
